...
vec3 MinLight = srgb_linear(vec3(c_MIN_LIGHT)) + nightVision * 0.01;
vec3 NightAmbientColor = srgb_linear(vec3(c_NIGHT_AMBIENT_R, c_NIGHT_AMBIENT_G, c_NIGHT_AMBIENT_B) * 0.75) + nightVision * 2;